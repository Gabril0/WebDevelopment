...
class Product
{
  ...
  function __construct($id, $name, $price, $imagePath) //construtor do objeto para atribuição
  {
    $this->id = $id;
    $this->name = $name;
    $this->price = $price;
...
$randProds = [
  //randomiza produtos para que apareçam aleatoriamente no site de acordo com o id, este JSON gera 5 produtos aleatórios
  $products[rand(0, 6)],
  $products[rand(0, 6)],
  $products[rand(0, 6)],
  $products[rand(0, 6)],
